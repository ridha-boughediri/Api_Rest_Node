...
db.Groupe = require('./models/groupe')(sequelize)
db.User.hasMany(db.Cocktail, {foreignKey: 'user_id', onDelete: 'cascade'})
db.Cocktail.belongsTo(db.User, {foreignKey: 'user_id'})
db.User.belongsTo(db.Groupe, {foreignKey: 'groupe_id'})
// db.User.hasMany(db.Groupe, {foreignKey: 'user_id', onDelete: 'cascade'})
